  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={() => handleButtonClick('new-signature')}
          className={`w-auto flex items-center justify-center transition-all duration-500 pl-6 pr-4 py-2 rounded-r-none rounded-l-lg gap-1 font-semibold h-12 ${
        ...
        <button
          ...
          className={`w-auto flex items-center justify-center transition-all duration-500 pr-6 pl-4 py-2 rounded-l-none gap-1 font-semibold h-12 ${
            selectedComponent === 'signature-tool' ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-800'
          }`}
        >
